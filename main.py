...
player1 = plr.Player(tank_list, 1, randint(1, int(window_width/2)), randint(30, int(window_height/2)))
player1_bullets = []

"---# The beginning of rendering cycle with 2 players #---"
run = True
if game_flag == 2:
    player2 = plr.Player(tank_list, 1, randint(1, int(window_width / 2)), randint(30, int(window_height / 2)))
    player2_bullets = []
    while run:
        screen.fill((0, 0, 0))
        ...
        "# Fonts rendering #"
        info_string.blit(hp_font.render(u"Lives: " + str(player1.hp), 1, (255, 0, 0)), (10, 5))
        info_string.blit(hp_font.render(u"Lives: " + str(player2.hp), 1, (255, 0, 0)), (window_width - 125, 5))
